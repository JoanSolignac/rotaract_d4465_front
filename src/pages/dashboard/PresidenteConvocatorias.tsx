...
export const PresidenteConvocatorias = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <section
        id="convocatorias"
        className="glass-card relative overflow-hidden p-6 text-white"
      >
        <div className="liquid-blob -left-10 top-0 h-48 w-48 bg-rotaract-pink/35" />
        <div className="liquid-blob right-0 top-6 h-40 w-40 bg-amber-200/25" />
        <div className="relative">
          <header className="mb-5 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="glass-card flex flex-wrap items-center gap-3 border-white/15 bg-white/5 px-4 py-3 text-sm text-rose-50">
              ...
              <Button color="light" className="border border-white/15 bg-white/5 text-white hover:!bg-white/10" onClick={loadConvocatorias}>
                Refrescar
              </Button>
              <Button
                color="light"
